...
button_data = {
    ...
    "Mamá (azúcar en la sangre)": {"action": "Notify CNA"},
    ...
    "No consigo sacar leche cuando uso el sacaleches. ¿Es normal?": {"note": "Sí, es común al principio. La leche puede tardar unos días en bajar. Siga usando el sacaleches cada 2-3 horas e informe a su enfermera si está preocupada."},
    "¿Cómo de seguido debo alimentar a mi bebé?": {"note": "Al menos cada 2-3 horas y cuando lo pida. Las señales de hambre incluyen buscar el pecho, chuparse las manos y estar inquieto."},
    "Me preocupa que mi bebé no esté recibiendo suficiente leche materna.": {"note": "Informe a su enfermera para que pueda ayudar. Las señales de que su bebé se está alimentando bien incluyen sonidos de deglución y pañales mojados regularmente. El reverso del registro de alimentación muestra cuántos pañales debe tener su bebé."},
    "Mi bebé tiene hipo.": {"note": "El hipo es normal en los recién nacidos y generalmente desaparece por sí solo. Intente sostener a su bebé en posición vertical."},
    "Mi bebé suena congestionado o ha estado estornudando. ¿Es normal?": {"note": "Sí, los recién nacidos a menudo estornudan y suenan congestionados. Si su bebé tiene problemas para alimentarse o respirar, informe a su enfermera."},
    "¿Le harán a mi bebé un examen de la vista?": {"note": "No, pero el pediatra mirará los ojos de su bebé con una luz."},
    "¿Puedo vestir a mi bebé con su propia ropa?": {"note": "Sí, puede vestir a su bebé, incluso si no se ha bañado. Se recomienda el contacto piel con piel, especialmente en los primeros días."},
    ...
    "¿Cuándo recibiré mis papeles de alta?": {"note": "Una vez que el ginecólogo y el pediatra hayan ingresado sus notas y órdenes de alta, su enfermera podrá imprimir la documentación."},
