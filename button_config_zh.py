...
button_data = {
    ...
    "submit_button": "提交选择",
    "confirmation_message": "您的请求已发送。",
    "selection_prompt": "请选择一个或多个项目。",
    "back_text": "⬅ 返回",
    ...
    "我应该多久使用一次吸奶器？": {
        "note": "如果您想建立或维持奶量，应每2-3小时使用一次。您的护士或哺乳顾问可以指导您。"
    },
    "我用吸奶器时吸不出母乳，这正常吗？": {
        "note": "是的，初期很常见。母乳可能需要几天才能下来。请继续每2-3小时使用吸奶器，如果担心，请告知您的护士。"
    },
    "我应该多久喂一次宝宝？": {
        "note": "至少每2-3小时喂一次，并按需喂养。饥饿的迹象包括寻乳反射、吸吮手和烦躁不安。"
    },
    "我担心宝宝没有吃到足够的母乳。": {
        "note": "请告知您的护士，以便他们提供帮助。宝宝吃得好的迹象包括能听到吞咽声和有规律的湿尿布。喂养日志的背面显示了您的宝宝应该有多少湿尿布。"
    },
    "我的宝宝打嗝了。": {
        "note": "打嗝在新生儿中很正常，通常会自行消失。尝试将宝宝竖直抱起。"
    },
    "我的宝宝听起来鼻塞或一直在打喷嚏，这正常吗？": {
        "note": "是的，新生儿经常打喷嚏并且听起来鼻塞。如果您的宝宝在喂养或呼吸时有困难，请告知您的护士。"
    },
    "会给我的宝宝做视力测试吗？": {
        "note": "不会，但儿科医生会用光照看宝宝的眼睛。"
    },
    "我可以给宝宝穿衣服吗？": {
        "note": "是的，您可以给宝宝穿衣服，即使他们还没有洗澡。鼓励肌肤接触，尤其是在最初几天。"
    },
    ...
    "我什么时候能拿到出院文件？": {
        "note": "一旦妇产科医生和儿科医生录入他们的医嘱和出院指令，您的护士就可以打印文件了。"
    },
    "我必须坐轮椅吗？": {
    ...
    "宝宝出院": {
        "note": "儿科医生需要在您住院期间每天为您的宝宝进行评估。宝宝的最短住院时间为24小时。您的宝宝需要能够很好地从乳房或奶瓶进食，体重下降在正常范围内，通过所有24小时的测试、听力测试，并且有正常的大小便。如果宝宝在37周前出生或GBS阳性且未得到足够抗生素治疗，可能需要住院48小时。请与护士和儿科医生讨论您宝宝的出院计划。"
    }
}
