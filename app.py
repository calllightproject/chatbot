...
# UPDATED: Function with smarter clinical judgment
def get_ai_response(question, context):
    ...
    **Patient's Message:** '{question}'
    ...
    try:
        ...
        return "NURSE_ACTION" # Default to nurse action on error for safety
